...
# create folder to save train result 
...
if not os.path.exists(Trained_models):
    ...
    print('{0} creat successful!'.format(Trained_models))
else:
    print('{0} has been exists.'.format(Trained_models))
...
def main():
	'''
		Training example with ABF2 factor, change the 
	fasta file name following pos_file to train another factor.
	'''
	pos_file = 'fasta/ABF2.fasta'
	neg_file = 'fasta/neg.fasta'
